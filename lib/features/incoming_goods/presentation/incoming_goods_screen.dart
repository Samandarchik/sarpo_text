...
import 'bloc/IncomingGoods_bloc.dart';
import 'bloc/IncomingGoods_event.dart';
import 'bloc/IncomingGoods_state.dart';
import 'dialog/add_factrys_dialog.dart';
import 'dialog/add_incoming_good_dialog.dart';

class IncomingGoodsScreen extends StatefulWidget {
  const IncomingGoodsScreen({super.key});

  @override
  State<IncomingGoodsScreen> createState() => _IncomingGoodsScreen();
}

class _IncomingGoodsScreen extends State<IncomingGoodsScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<IncomingGoodsScreenBloc, IncomingGoodsState>(
      listener: (context, state) {},
      builder: (context, state) {
        final products = state.incomingGood;
  ...
  Widget _buildProductListTable(
    List<IncomingGoodsItem> products,
  ...
  Widget _buildHeader( IncomingGoodsState incoming) {
    return Container(
